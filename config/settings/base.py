...
# hirethon_template/
APPS_DIR = BASE_DIR / "hirethon_template"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "hirethon_template.contrib.sites.migrations"}
...
ACCOUNT_FORMS = {"signup": "hirethon_template.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
SPECTACULAR_SETTINGS = {
    "TITLE": "hirethon-template API",
    "DESCRIPTION": "Documentation of API endpoints of hirethon-template",
    "VERSION": "1.0.0",
...
ADMIN_INDEX_TITLE = "Welcome to {} Admin Portal".format("hirethon_template".title())
